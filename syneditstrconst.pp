...
$Id: syneditstrconst.pp 25432 2010-05-15 15:49:06Z martin $
...
resourcestring
  ...
  SYNS_AttrListOfValues         =  'List of Values';
...
const
  ...
  *)
  ...
  SYNS_XML_ListOfValues             :String = SYNS_AttrListOfValues;
...
{$ENDIF}
  ...
  SYNS_LangTeX                  =  'TeX';
  SYNS_LangBasicConfig          =  'Basic Configuration';
  SYNS_LangRuby                 =  'Ruby';
